  ...
  ROLE_ADMIN: [
    ...
    },
    {
      ...
      items: [
        ...
        { label: "Historial Atendidos",   icon: Activity,     path: "/dashboard/historial-realizados" },
  ...
  ROLE_DERIVADOR: [
    {
      title: "Mis Pacientes",
      items: [
        { label: "Pacientes Derivados",   icon: Users,         path: "/dashboard/mis-pacientes-derivados" },
        { label: "Estudios Solicitados",  icon: Activity,      path: "/dashboard/estudios-solicitados" },
      ],
    },
  ],
};
