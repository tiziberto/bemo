  ...
  routes: [
    ...
    { path: "/acceso-denegado", component: () => import("@/pages/AccessDenied.vue") },
    {
      ...
      children: [
        ...
        { path: "historial-realizados", component: () => import("@/pages/dashboard/HistorialRealizadosPage.vue") },
        // ROLE_DERIVADOR routes
        { path: "solicitar-estudio", component: () => import("@/pages/dashboard/DashboardPlaceholder.vue") },
        { path: "estudios-solicitados", component: () => import("@/pages/dashboard/DerivadosPage.vue") },
        { path: "estado-pedidos", component: () => import("@/pages/dashboard/DerivadosPage.vue") },
        { path: "mis-pacientes-derivados", component: () => import("@/pages/dashboard/DerivadosPage.vue") },
