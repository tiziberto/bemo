...
CREATE TABLE `afiliaciones` (
  ...
  `idosocial` int(11) NOT NULL,
  `idplan` int(11) NOT NULL,
  `idafiliado` varchar(25) NOT NULL,
  `idtipoafi` int(11) NOT NULL,
  `idusuario` varchar(20) NOT NULL,
  `fecmodifica` date NOT NULL
...
CREATE TABLE `caja` (
  ...
  `nroasignado` int(9) NOT NULL DEFAULT 0,
  `idpaciente` double NOT NULL DEFAULT 0,
  `idosocial` int(4) NOT NULL DEFAULT 0,
  `nrobono` int(4) NOT NULL DEFAULT 0,
  `fecha` datetime DEFAULT NULL,
  `idprestador` int(11) NOT NULL DEFAULT 0,
  `coseguro` double NOT NULL,
  `pago_e` double NOT NULL,
  `endeposito` int(11) NOT NULL DEFAULT 0,
  `observa` longtext NOT NULL,
  `idespecia` int(11) NOT NULL DEFAULT 1,
  `idusuario` text CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL,
...
--
-- Table structure for table `datos_informes`
--

DROP TABLE IF EXISTS `datos_informes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `datos_informes` (
  `nombre_archivo` varchar(97) DEFAULT NULL,
  `solicitante` varchar(38) DEFAULT NULL,
  `efector` varchar(41) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `depositos` (
  ...
  `nroasignado` double NOT NULL,
  `idpaciente` double NOT NULL,
  `fecha` datetime NOT NULL,
  `idprestador` int(11) NOT NULL,
  `importe` double NOT NULL,
  `fecingreso` datetime NOT NULL,
  `idusuario` varchar(50) NOT NULL,
  `idtiporecu` int(11) NOT NULL DEFAULT 0,
  `fecrecupero` datetime NOT NULL DEFAULT '1900-01-01 00:00:00',
  `idusurecu` varchar(50) NOT NULL DEFAULT '.',
  `nrorecupero` double NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `especialidades` (
  ...
  `detalle` varchar(100) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `estado_turnos`
--
...
--
-- Table structure for table `fordenes`
--

DROP TABLE IF EXISTS `fordenes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `fordenes` (
  `idconsultorio` int(11) NOT NULL DEFAULT 0,
  `nroasignado` int(9) NOT NULL DEFAULT 0,
  `idpaciente` double NOT NULL DEFAULT 0,
  `idosocial` int(4) NOT NULL DEFAULT 0,
  `idafiliado` varchar(30) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL DEFAULT '0',
  `nrobono` int(4) NOT NULL DEFAULT 0,
  `fecrealiza` date DEFAULT NULL,
  `idnomencla` varchar(9) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL DEFAULT '0',
  `idsolicitante` int(4) NOT NULL DEFAULT 0,
  `porc_solic` int(11) NOT NULL DEFAULT 0,
  `idprestador` int(11) NOT NULL DEFAULT 0,
  `porc_efec` int(11) NOT NULL DEFAULT 0,
  `importe` double NOT NULL,
  `honorario` decimal(8,2) NOT NULL DEFAULT 0.00,
  `gasto` decimal(8,2) NOT NULL DEFAULT 0.00,
  `iva` decimal(8,2) NOT NULL DEFAULT 0.00,
  `imptotal` decimal(8,2) NOT NULL DEFAULT 0.00,
  `coseguro` double NOT NULL,
  `pago_e` double NOT NULL DEFAULT 0,
  `tipo_pago` int(11) NOT NULL DEFAULT 0,
  `idtipoafi` int(4) NOT NULL DEFAULT 0,
  `idplan` int(4) NOT NULL DEFAULT 0,
  `idorigen` int(11) NOT NULL DEFAULT 1,
  `idperiodo` float NOT NULL,
  `marca` int(11) NOT NULL DEFAULT 0,
  `idusuario` text CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL,
  `fecingreso` date DEFAULT NULL,
  `idusumarca` varchar(50) NOT NULL DEFAULT '.',
  `fecmarca` datetime NOT NULL DEFAULT '1900-01-01 00:00:00',
  `generado` int(11) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `fordenes_h`
--

DROP TABLE IF EXISTS `fordenes_h`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `fordenes_h` (
  `idconsultorio` int(11) NOT NULL DEFAULT 0,
  `nroasignado` int(9) NOT NULL DEFAULT 0,
  `idpaciente` double NOT NULL DEFAULT 0,
  `idosocial` int(4) NOT NULL DEFAULT 0,
...
CREATE TABLE `horarios` (
  `idprestador` int(11) NOT NULL,
  `lunddem` time NOT NULL,
  `lunhtam` time NOT NULL,
  `lunddet` time NOT NULL,
  `lunhtat` time NOT NULL,
  `marddem` time NOT NULL,
  `marhtam` time NOT NULL,
  `marddet` time NOT NULL,
  `marhtat` time NOT NULL,
  `mieddem` time NOT NULL,
  `miehtam` time NOT NULL,
  `mieddet` time NOT NULL,
  `miehtat` time NOT NULL,
  `jueddem` time NOT NULL,
  `juehtam` time NOT NULL,
  `jueddet` time NOT NULL,
  `juehtat` time NOT NULL,
  `vieddem` time NOT NULL,
  `viehtam` time NOT NULL,
  `vieddet` time NOT NULL,
  `viehtat` time NOT NULL,
  `sabddem` time NOT NULL,
  `sabhtam` time NOT NULL,
  `sabddet` time NOT NULL,
  `sabhtat` time NOT NULL,
  `durlun` time NOT NULL,
  `durmar` time NOT NULL,
  `durmie` time NOT NULL,
  `durjue` time NOT NULL,
  `durvie` time NOT NULL,
  `dursab` time NOT NULL,
  `idusuario` varchar(20) NOT NULL DEFAULT '.',
  `fecmodifica` date NOT NULL DEFAULT '1900-01-01'
...
--
-- Table structure for table `informe_estudios`
--

DROP TABLE IF EXISTS `informe_estudios`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `informe_estudios` (
  `nroasignado` double NOT NULL DEFAULT 0,
  `idinforme` double NOT NULL DEFAULT 0,
  `idpaciente` int(11) NOT NULL DEFAULT 0,
  `fecrealiza` date NOT NULL,
  `idprestador` int(11) NOT NULL DEFAULT 0,
  `idnomencla` varchar(20) NOT NULL,
  `texto` text NOT NULL,
  `fecinforme` date NOT NULL,
  `idusuario` varchar(20) NOT NULL,
  `fecmodifica` datetime NOT NULL,
...
--
-- Table structure for table `log_confirma`
--

DROP TABLE IF EXISTS `log_confirma`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `log_confirma` (
  `idpaciente` float NOT NULL,
  `idprestador` int(11) NOT NULL,
...
CREATE TABLE `mensajes` (
  ...
  `idusuario` varchar(50) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL,
  `asunto` varchar(250) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL,
  `texto` text CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL,
  `idremite` varchar(50) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL,
  `fec_envio` datetime NOT NULL,
  `visto` int(11) NOT NULL,
  `fec_visto` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `nomenclador` (
  `idperiodo` double NOT NULL DEFAULT 0,
  `idosocial` int(6) NOT NULL DEFAULT 0,
  `idnomencla` varchar(10) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL DEFAULT '0',
  `detalle` varchar(200) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL DEFAULT '0',
  `idgaleno` int(6) NOT NULL DEFAULT 0,
  `galespecial` double NOT NULL DEFAULT 0,
  `idgasto` int(6) NOT NULL DEFAULT 0,
  `unidgastos` double NOT NULL DEFAULT 0,
  `idespecia` int(6) NOT NULL DEFAULT 0,
  `vigente` varchar(1) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL DEFAULT 'S',
  `imptita` double NOT NULL DEFAULT 0,
  `impgasa` double NOT NULL DEFAULT 0,
  `imptitb` double NOT NULL DEFAULT 0,
  `impgasb` double NOT NULL DEFAULT 0,
  `imptitc` double NOT NULL DEFAULT 0,
  `impgasc` double NOT NULL DEFAULT 0,
  `idusuario` varchar(20) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL DEFAULT '.',
  `fecmodifica` date NOT NULL DEFAULT '1900-01-01'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `nomenclador_2023`
--

DROP TABLE IF EXISTS `nomenclador_2023`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `nomenclador_2023` (
  `idperiodo` double NOT NULL DEFAULT 0,
  `idosocial` int(6) NOT NULL DEFAULT 0,
  `idnomencla` varchar(10) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL DEFAULT '0',
  `detalle` varchar(200) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL DEFAULT '0',
...
--
-- Table structure for table `osociales`
--

DROP TABLE IF EXISTS `osociales`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `osociales` (
  `idosocial` int(11) NOT NULL DEFAULT 0,
  `detalle` varchar(150) NOT NULL DEFAULT ' ',
  `abrevia` varchar(20) NOT NULL DEFAULT ' ',
  `idcondiva` int(11) NOT NULL DEFAULT 5,
  `idusuario` varchar(20) NOT NULL DEFAULT '.',
  `fecmodifica` date NOT NULL DEFAULT '1900-01-01'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pacientes` (
  ...
  `nrointerno` varchar(10) NOT NULL DEFAULT ' ',
...
--
-- Table structure for table `pre_informes`
--

DROP TABLE IF EXISTS `pre_informes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `pre_informes` (
  `idpreinforme` int(11) NOT NULL,
...
CREATE TABLE `prestadores` (
  `idprestador` int(6) NOT NULL DEFAULT 0,
  `nombre` varchar(50) NOT NULL DEFAULT '0',
  `categoria` char(1) NOT NULL DEFAULT '0',
  `telefono` varchar(25) NOT NULL,
  `cuit` varchar(20) NOT NULL DEFAULT '0',
  `idcondiva` int(2) DEFAULT NULL,
  `email` varchar(100) NOT NULL DEFAULT '0',
  `matricula` varchar(10) NOT NULL DEFAULT '0',
  `fecalta` date DEFAULT NULL,
  `fecbaja` date DEFAULT NULL,
  `porcentaje_efe` int(11) NOT NULL,
  `especialidad` varchar(150) NOT NULL,
  `asigna_turnos` varchar(1) NOT NULL DEFAULT 'N',
...
--
-- Temporary table structure for view `privileges_by_table_by_level`
--

DROP TABLE IF EXISTS `privileges_by_table_by_level`;
/*!50001 DROP VIEW IF EXISTS `privileges_by_table_by_level`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `privileges_by_table_by_level` AS SELECT
 1 AS `TABLE_SCHEMA`,
  1 AS `TABLE_NAME`,
  1 AS `GRANTEE`,
  1 AS `PRIVILEGE`,
...
--
-- Table structure for table `resumen_facturado`
--

DROP TABLE IF EXISTS `resumen_facturado`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `resumen_facturado` (
  `idconsultorio` int(11) NOT NULL DEFAULT 0,
  `nroasignado` int(9) NOT NULL DEFAULT 0,
  `idpaciente` double NOT NULL DEFAULT 0,
  `idosocial` int(4) NOT NULL DEFAULT 0,
  ...
  `nrobono` int(4) NOT NULL DEFAULT 0,
  `fecrealiza` date DEFAULT NULL,
  `idespecia` int(11) NOT NULL DEFAULT 0,
  `idnomencla` varchar(9) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL DEFAULT '0',
  `idsolicitante` int(4) NOT NULL DEFAULT 0,
  `porc_solic` int(11) NOT NULL DEFAULT 0,
  `idprestador` int(11) NOT NULL DEFAULT 0,
...
CREATE TABLE `solicitantes` (
  `idsolicitante` int(6) NOT NULL DEFAULT 0,
  `nombre` varchar(50) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL DEFAULT '0',
  `porcentaje_sol` int(11) NOT NULL DEFAULT 0,
  `fecmodifica` date NOT NULL DEFAULT '1900-01-01',
  `idusuario` varchar(20) CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL DEFAULT '.'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `tipoafi`
--

DROP TABLE IF EXISTS `tipoafi`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `tipoafi` (
  `idtipoafi` int(11) NOT NULL,
  `detalle` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `tipoafih`
--

DROP TABLE IF EXISTS `tipoafih`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `tipoafih` (
  `idtipoafi` int(11) NOT NULL,
...
--
-- Table structure for table `tiporecupero`
--

DROP TABLE IF EXISTS `tiporecupero`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `tiporecupero` (
  `idtiporecu` int(11) NOT NULL,
  `detalle` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `tmp_fordenes`
--

DROP TABLE IF EXISTS `tmp_fordenes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `tmp_fordenes` (
  `idconsultorio` int(11) NOT NULL DEFAULT 0,
  `nroasignado` int(9) NOT NULL DEFAULT 0,
  `idpaciente` double NOT NULL DEFAULT 0,
  `idosocial` int(4) NOT NULL DEFAULT 0,
...
CREATE TABLE `turnos` (
  ...
  `idusuario` varchar(20) NOT NULL DEFAULT '.',
  `fecmodifica` varchar(20) NOT NULL DEFAULT '1900-01-01'
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `turnos_2022`
--

DROP TABLE IF EXISTS `turnos_2022`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `turnos_2022` (
  `idconsultorio` int(11) NOT NULL,
  `idprestador` int(11) NOT NULL,
  `fecha` date NOT NULL,
  `hora` time NOT NULL,
...
--
-- Table structure for table `turnosh`
--

DROP TABLE IF EXISTS `turnosh`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `turnosh` (
  `idconsultorio` int(11) NOT NULL,
  `idprestador` int(11) NOT NULL,
  `fecha` date NOT NULL,
  `hora` time NOT NULL,
...
CREATE TABLE `url` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=186011 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `usuarios` (
  ...
  `fecbaja` date DEFAULT NULL,
  `idprestador` int(11) NOT NULL DEFAULT 0,
  `idusumodi` varchar(20) NOT NULL DEFAULT '.',
  `fecmodifica` date NOT NULL DEFAULT '1900-01-01'
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `variables` (
  `NroAsignado` double NOT NULL DEFAULT 0,
  `Empresa` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL DEFAULT '.',
  `Domicilio` varchar(150) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL DEFAULT '.',
  `Telefono` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL DEFAULT '.',
...
/*!50001 CREATE ALGORITHM=TEMPTABLE */
/*!50013 DEFINER=`mariadb.sys`@`localhost` SQL SECURITY INVOKER */
/*!50001 VIEW `memory_global_total` AS select format_bytes(sum(`performance_schema`.`memory_summary_global_by_event_name`.`CURRENT_NUMBER_OF_BYTES_USED`)) AS `total_allocated` from `performance_schema`.`memory_summary_global_by_event_name` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `privileges_by_table_by_level`
--
...
-- Dump completed on 2026-03-16 23:28:19
